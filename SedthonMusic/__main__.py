...
from SedthonMusic.misc import sudo
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("SedthonMusic.plugins" + all_module)
    LOGGER("SedthonMusic.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Anony.start()
    try:
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("SedthonMusic").info("Stopping AnonX Music Bot...")
